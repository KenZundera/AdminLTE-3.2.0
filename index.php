<?php 
  // ob_start();
  // session_start();
  // // array akun_id bisa diganti apa saja
...
<html lang="en">
  ...
  >
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img
                src="assets/dist/img/profile.jpeg"
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="index.php?page=data_user" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Dashboard v2</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a
                      href="assets/pages/layout/top-nav-sidebar.html"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a
                      href="assets/pages/layout/fixed-sidebar.html"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                      <p>Fixed Sidebar</p>
                  ...
                  <li class="nav-item">
                    <a
                      href="assets/pages/layout/fixed-sidebar-custom.html"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a
                      href="assets/pages/layout/fixed-topnav.html"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                      <p>Fixed Navbar</p>
                  ...
                  <li class="nav-item">
                    <a
                      href="assets/pages/layout/fixed-footer.html"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                      <p>Fixed Footer</p>
                  ...
                  <li class="nav-item">
                    <a
                      href="assets/pages/layout/collapsed-sidebar.html"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a
                      href="assets/pages/forms/validation.html"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                      <p>Validation</p>
    ...
    <script src="assets/dist/js/assets/pages/dashboard2.js"></script>
    <!-- jQuery -->
